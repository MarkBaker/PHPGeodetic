...
class Geodetic_UTM
{
    ...
    public function setNorthing($northing = NULL)
    {
        if (!is_numeric($northing)) {
            throw new Geodetic_Exception('Northing must be a numeric value');
        }
    ...
    public function setEasting($easting = NULL)
    {
        if (!is_numeric($easting)) {
            throw new Geodetic_Exception('Easting must be a numeric value');
        }
    ...
    public function setLatitudeZone($latitudeZone = NULL)
    {
        ...
        if (!(isset(self::$_latitudeZones[$latitudeZone]) || $latitudeZone == 'Z')) {
            throw new Geodetic_Exception('Invalid Latitude Zone');
        }

        $this->_latitudeZone = $latitudeZone;
    ...
    public function setLongitudeZone($longitudeZone = NULL)
    {
        if (!is_numeric($longitudeZone)) {
            throw new Geodetic_Exception('Invalid Longitude Zone');
        }

        $this->_longitudeZone = $longitudeZone;
    ...
    public function toLatLong(Geodetic_Datum $datum = NULL)
    {
        ...
        $easting = $this->_easting - 500000.0;;
        $northing = $this->_northing;
        $zoneNumber = $this->_longitudeZone;
        $zoneLetter = $this->_latitudeZone;
    ...
    {
        foreach(self::$_latitudeZones as $zone => $range) {
