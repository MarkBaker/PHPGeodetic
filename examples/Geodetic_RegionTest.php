...
foreach($latLongArray as $latLongValues) {
    $latLong = new Geodetic_LatLong_CoordinateValues(
        $latLongValues[0],
        $latLongValues[1],
    ...
    $regionArray[] = new Geodetic_LatLong($latLong);
}
$region = new Geodetic_Region($regionArray);
...
echo '    Kilometres: ', $perimeter1->getValue(Geodetic_Distance::KILOMETRES) , PHP_EOL;
echo '    Metres: ', $perimeter1->getValue() , PHP_EOL;
echo '    Miles: ', $perimeter1->getValue(Geodetic_Distance::MILES) , PHP_EOL;
echo '    Yards: ', $perimeter1->getValue(Geodetic_Distance::YARDS) , PHP_EOL;
echo '    Nautical Miles: ', $perimeter1->getValue(Geodetic_Distance::NAUTICAL_MILES) , PHP_EOL , PHP_EOL;

echo 'Perimeter (using Haversine): ' , PHP_EOL;

$perimeter2 = $region->getPerimeter(NULL,TRUE);

echo '    Kilometres: ', $perimeter2->getValue(Geodetic_Distance::KILOMETRES) , PHP_EOL;
echo '    Metres: ', $perimeter2->getValue() , PHP_EOL;
echo '    Miles: ', $perimeter2->getValue(Geodetic_Distance::MILES) , PHP_EOL;
echo '    Yards: ', $perimeter2->getValue(Geodetic_Distance::YARDS) , PHP_EOL;
echo '    Nautical Miles: ', $perimeter2->getValue(Geodetic_Distance::NAUTICAL_MILES) , PHP_EOL , PHP_EOL;
...
echo '    Square Kilometres: ', $area1->getValue(Geodetic_Area::SQUARE_KILOMETRES) , PHP_EOL;
echo '    Square Metres: ', $area1->getValue() , PHP_EOL;
echo '    Hectares: ', $area1->getValue(Geodetic_Area::HECTARES) , PHP_EOL;
echo '    Square Miles: ', $area1->getValue(Geodetic_Area::SQUARE_MILES) , PHP_EOL;
echo '    Acres: ', $area1->getValue(Geodetic_Area::ACRES) , PHP_EOL , PHP_EOL;

echo 'Surface Area: ' , PHP_EOL;

$area2 = $region->getArea();

echo '    Square Kilometres: ', $area2->getValue(Geodetic_Area::SQUARE_KILOMETRES) , PHP_EOL;
