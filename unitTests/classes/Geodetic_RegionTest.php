...
class RegionTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_xLatitude2 = $this->getMock('Geodetic_Angle');
        $this->_xLatitude2->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(53.477831));
        $this->_yLongitude2 = $this->getMock('Geodetic_Angle');
        $this->_yLongitude2->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(-2.242584));
        $this->_zHeight2 = $this->getMock('Geodetic_Distance');
        $this->_zHeight2->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(0.0));

        $this->_xyz2 = $this->getMock('Geodetic_LatLong');
        ...
        $this->_xLatitude3 = $this->getMock('Geodetic_Angle');
        $this->_xLatitude3->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(53.760484));
        $this->_yLongitude3 = $this->getMock('Geodetic_Angle');
        $this->_yLongitude3->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(-2.704010));
        $this->_zHeight3 = $this->getMock('Geodetic_Distance');
        $this->_zHeight3->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(0.0));

        $this->_xyz3 = $this->getMock('Geodetic_LatLong');
        ...
        $this->_xLatitude4 = $this->getMock('Geodetic_Angle');
        $this->_xLatitude4->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(53.540307));
        $this->_yLongitude4 = $this->getMock('Geodetic_Angle');
        $this->_yLongitude4->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(-2.635345));
        $this->_zHeight4 = $this->getMock('Geodetic_Distance');
        $this->_zHeight4->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(0.0));

        $this->_xyz4 = $this->getMock('Geodetic_LatLong');
        ...
        $this->_xLatitude5 = $this->getMock('Geodetic_Angle');
        $this->_xLatitude5->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(53.574773));
        $this->_yLongitude5 = $this->getMock('Geodetic_Angle');
        $this->_yLongitude5->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(-3.073683));
        $this->_zHeight5 = $this->getMock('Geodetic_Distance');
        $this->_zHeight5->expects($this->any())
            ->method('getValue')
            ->will($this->returnValue(0.0));

        $this->_xyz5 = $this->getMock('Geodetic_LatLong');
    ...
    {
        $regionObject = new Geodetic_Region();
        //    Must return an object...
        $this->assertTrue(is_object($regionObject));
        //    ... of the correct type
        $this->assertTrue(is_a($regionObject, 'Geodetic_Region'));
	}
    ...
    public function testInstantiateWithValues()
    {
        ...
        $this->assertEquals(3,count($pointSet));
    }
